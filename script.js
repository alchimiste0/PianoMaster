...
// =================================================================
// 2. BIBLIOTHÈQUE DE CHANSONS (VERSIONS LONGUES)
// =================================================================
const lessons = [
    {
        id: "all_of_me_full",
        ...
        data: [
            ...
            // COUPLET 2
            {n: "C4", l: "How"}, {n: "C4", l: "ma"}, {n: "C4", l: "ny"}, {n: "D#4", l: "times"}, {n: "F4", l: "do"}, {n: "F4", l: "I"}, {n: "D#4", l: "have"}, {n: "C4", l: "to"}, {n: "A#3", l: "tell"}, {n: "A#3", l: "you"},
            {n: "C4", l: "E"}, {n: "C4", l: "ven"}, {n: "C4", l: "when"}, {n: "D#4", l: "you're"}, {n: "F4", l: "cry"}, {n: "F4", l: "ing"}, {n: "D#4", l: "you're"}, {n: "C4", l: "beau"}, {n: "D#4", l: "ti"}, {n: "C4", l: "ful"}, {n: "A#3", l: "too"},
            {n: "F4", l: "The"}, {n: "D#4", l: "world"}, {n: "C#4", l: "is"}, {n: "C4", l: "bea"}, {n: "A#3", l: "ting"}, {n: "G#3", l: "you"}, {n: "A#3", l: "down"}, {n: "C4", l: "I'm"}, {n: "A#3", l: "a"}, {n: "G#3", l: "round"}, {n: "F4", l: "through"}, {n: "D#4", l: "eve"}, {n: "C#4", l: "ry"}, {n: "C4", l: "mood"},
            {n: "C4", l: "You're"}, {n: "C#4", l: "my"}, {n: "D#4", l: "down"}, {n: "F4", l: "fall"}, {n: "D#4", l: "you're"}, {n: "D#4", l: "my"}, {n: "C#4", l: "muse"},
            {n: "D#4", l: "My"}, {n: "C#4", l: "worst"}, {n: "C4", l: "dis"}, {n: "A#3", l: "trac"}, {n: "G#3", l: "tion"}, {n: "A#3", l: "my"}, {n: "C4", l: "rhy"}, {n: "A#3", l: "thm"}, {n: "G#3", l: "and"}, {n: "F3", l: "blues"},
            {n: "F4", l: "I"}, {n: "D#4", l: "can't"}, {n: "C#4", l: "stop"}, {n: "C4", l: "sing"}, {n: "A#3", l: "ing"}, {n: "A#3", l: "it's"}, {n: "C4", l: "rin"}, {n: "A#3", l: "ging"}, {n: "G#3", l: "in"}, {n: "F3", l: "my"}, {n: "F3", l: "head"}, {n: "D#4", l: "for"}, {n: "C#4", l: "you"},
            // PRÉ-CHORUS 2
            {n: "C4", l: "My"}, {n: "C4", l: "head's"}, {n: "C#4", l: "un"}, {n: "D#4", l: "der"}, {n: "F4", l: "wa"}, {n: "D#4", l: "ter"}, {n: "D#4", l: "But"}, {n: "C#4", l: "I'm"}, {n: "C4", l: "brea"}, {n: "A#3", l: "thing"}, {n: "G#3", l: "fine"},
            {n: "C4", l: "You're"}, {n: "C#4", l: "cra"}, {n: "D#4", l: "zy"}, {n: "F4", l: "and"}, {n: "D#4", l: "I'm"}, {n: "C#4", l: "out"}, {n: "C4", l: "of"}, {n: "A#3", l: "my"}, {n: "G#3", l: "mind"},
            // REFRAIN 2
            ...
            {n: "C#4", l: "And"}, {n: "C4", l: "you"}, {n: "A#3", l: "give"}, {n: "C4", l: "me"}, {n: "C#4", l: "all"}, {n: "D#4", l: "..."}, {n: "C#4", l: "of"}, {n: "C4", l: "you"},
            // PONT
            {n: "F4", l: "Cards"}, {n: "F4", l: "on"}, {n: "F4", l: "the"}, {n: "F4", l: "ta"}, {n: "D#4", l: "ble"}, {n: "G#3", l: "we're"}, {n: "C#4", l: "both"}, {n: "D#4", l: "sho"}, {n: "C#4", l: "wing"}, {n: "C4", l: "hearts"}, {n: "A#3", l: "hearts"},
            {n: "C#4", l: "Ris"}, {n: "C#4", l: "king"}, {n: "C#4", l: "it"}, {n: "C#4", l: "all"}, {n: "C4", l: "though"}, {n: "A#3", l: "it's"}, {n: "G#3", l: "hard"},
            // FINAL
            {n: "F4", l: "Cause"}, {n: "G4", l: "all"}, {n: "G#4", l: "of"}, {n: "F4", l: "me"}, {n: "D#4", l: "Loves"}, {n: "C#4", l: "all"}, {n: "D#4", l: "of"}, {n: "C#4", l: "you"},
            {n: "C4", l: "Love"}, {n: "A#3", l: "your"}, {n: "C4", l: "curves"}, {n: "C#4", l: "and"}, {n: "C4", l: "all"}, {n: "A#3", l: "your"}, {n: "C4", l: "ed"}, {n: "A#3", l: "ges"},
            {n: "C4", l: "All"}, {n: "A#3", l: "your"}, {n: "C4", l: "per"}, {n: "C#4", l: "fect"}, {n: "C4", l: "im"}, {n: "A#3", l: "per"}, {n: "G#3", l: "fec"}, {n: "F3", l: "tions"},
    ...
    },
    {
        ...
        data: [
            ...
            // COUPLET 2
            {n: "D#4", l: "Well"}, {n: "F4", l: "I"}, {n: "G#4", l: "found"}, {n: "G#4", l: "a"}, {n: "F4", l: "wo"}, {n: "D#4", l: "man"}, {n: "D#4", l: "Stron"}, {n: "F4", l: "ger"}, {n: "G#4", l: "than"}, {n: "G#4", l: "a"}, {n: "F4", l: "ny"}, {n: "D#4", l: "one"}, {n: "C#4", l: "I"}, {n: "C4", l: "know"},
            {n: "C#4", l: "She"}, {n: "C4", l: "shares"}, {n: "D#4", l: "my"}, {n: "C4", l: "dreams"}, {n: "A#3", l: "I"}, {n: "G#3", l: "hope"}, {n: "C4", l: "that"}, {n: "D#4", l: "some"}, {n: "D#4", l: "day"}, {n: "D#4", l: "I'll"}, {n: "F4", l: "share"}, {n: "G#4", l: "her"}, {n: "G#4", l: "home"},
            {n: "A#4", l: "I"}, {n: "G#4", l: "found"}, {n: "G4", l: "a"}, {n: "F4", l: "love"}, {n: "D#4", l: "to"}, {n: "D#4", l: "car"}, {n: "F4", l: "ry"}, {n: "G#4", l: "more"}, {n: "G#4", l: "than"}, {n: "F4", l: "just"}, {n: "F4", l: "my"}, {n: "D#4", l: "secrects"},
            {n: "D#4", l: "To"}, {n: "C#4", l: "car"}, {n: "C4", l: "ry"}, {n: "D#4", l: "love"}, {n: "C4", l: "to"}, {n: "A#3", l: "car"}, {n: "G#3", l: "ry"}, {n: "C4", l: "child"}, {n: "D#4", l: "ren"}, {n: "D#4", l: "of"}, {n: "F4", l: "our"}, {n: "G#4", l: "own"},
            // PRÉ-REFRAIN 2
            {n: "G#4", l: "We"}, {n: "G#4", l: "are"}, {n: "A#4", l: "still"}, {n: "C5", l: "kids"}, {n: "C5", l: "but"}, {n: "A#4", l: "we're"}, {n: "G#4", l: "so"}, {n: "A#4", l: "in"}, {n: "G#4", l: "love"},
            {n: "G#4", l: "Figh"}, {n: "A#4", l: "ting"}, {n: "C5", l: "a"}, {n: "C5", l: "gainst"}, {n: "A#4", l: "all"}, {n: "G#4", l: "odds"},
            {n: "G#4", l: "I"}, {n: "A#4", l: "know"}, {n: "C5", l: "we'll"}, {n: "C5", l: "be"}, {n: "A#4", l: "al"}, {n: "G#4", l: "right"}, {n: "A#4", l: "this"}, {n: "G#4", l: "time"},
            {n: "G#4", l: "Dar"}, {n: "A#4", l: "ling"}, {n: "C5", l: "just"}, {n: "C5", l: "hold"}, {n: "C5", l: "my"}, {n: "A#4", l: "hand"}, {n: "G#4", l: "Be"}, {n: "A#4", l: "my"}, {n: "C5", l: "girl"}, {n: "C5", l: "I'll"}, {n: "C5", l: "be"}, {n: "A#4", l: "your"}, {n: "G#4", l: "man"}, {n: "G#4", l: "I"}, {n: "G#4", l: "see"}, {n: "A#4", l: "my"}, {n: "C5", l: "fu"}, {n: "C5", l: "ture"}, {n: "C#5", l: "in"}, {n: "C5", l: "your"}, {n: "A#4", l: "eyes"},
            // REFRAIN 2
            {n: "D#4", l: "Ba"}, {n: "G#4", l: "by"}, {n: "C5", l: "I'm"}, {n: "A#4", l: "dan"}, {n: "G#4", l: "cing"}, {n: "C5", l: "in"}, {n: "A#4", l: "the"}, {n: "G#4", l: "dark"},
            {n: "G4", l: "with"}, {n: "G#4", l: "you"}, {n: "A#4", l: "be"}, {n: "G#4", l: "tween"}, {n: "G4", l: "my"}, {n: "F4", l: "arms"},
            {n: "C5", l: "Bare"}, {n: "A#4", l: "foot"}, {n: "G#4", l: "on"}, {n: "C5", l: "the"}, {n: "A#4", l: "grass"},
            {n: "G4", l: "lis"}, {n: "G#4", l: "tening"}, {n: "A#4", l: "to"}, {n: "G#4", l: "our"}, {n: "G4", l: "fa"}, {n: "F4", l: "vorite"}, {n: "F4", l: "song"},
            {n: "C5", l: "When"}, {n: "C#5", l: "you"}, {n: "C5", l: "said"}, {n: "A#4", l: "you"}, {n: "G#4", l: "in"}, {n: "A#4", l: "that"}, {n: "C5", l: "dress"}, {n: "C5", l: "loo"}, {n: "C#5", l: "king"}, {n: "C5", l: "so"}, {n: "A#4", l: "beau"}, {n: "G#4", l: "ti"}, {n: "A#4", l: "ful"}, {n: "C5", l: "I"}, {n: "C5", l: "don't"}, {n: "C5", l: "de"}, {n: "A#4", l: "serve"}, {n: "G#4", l: "this"},
            {n: "C5", l: "Dar"}, {n: "C#5", l: "ling"}, {n: "C5", l: "you"}, {n: "A#4", l: "look"}, {n: "G#4", l: "per"}, {n: "F4", l: "fect"}, {n: "D#4", l: "to"}, {n: "G#4", l: "night"},
            {n: "G#4", l: "❤️"}
        ]
    },
    {
...
function loadLesson(lesson) {
    ...
    // Auto-scroll clavier au début seulement
...
function renderSheetMusic() {
    ...
    currentLesson.data.forEach((item, i) => {
        const noteObj = fullNoteTable.find(n => n.note === item.n);
        if(!noteObj) return;
        ...
        if(noteObj.isBlack) el.classList.add('is-black');

        if(item.l) {
            const lyricEl = document.createElement('div');
            lyricEl.className = 'lyric-text';
            lyricEl.innerText = item.l;
...
document.getElementById('prev-btn').addEventListener('click', () => {
    if(!currentLesson || currentNoteIndex <= 0) return;
    const prevNoteEl = document.getElementById(`note-${currentNoteIndex - 1}`);
    if(prevNoteEl) prevNoteEl.classList.remove('correct');
    currentNoteIndex--;
    updateGameVisuals();
});

document.getElementById('next-btn').addEventListener('click', () => {
    if(!currentLesson || currentNoteIndex >= currentLesson.data.length - 1) return;
    const currentNoteEl = document.getElementById(`note-${currentNoteIndex}`);
    if(currentNoteEl) currentNoteEl.classList.add('correct');
    currentNoteIndex++;
    updateGameVisuals();
});
...
function updateAssistVisuals() {
    document.querySelectorAll('.key.suggested').forEach(k => k.classList.remove('suggested'));
    if(isAssistMode && currentLesson && currentNoteIndex < currentLesson.data.length) {
        const targetNote = currentLesson.data[currentNoteIndex].n;
        const keyEl = document.querySelector(`.key[data-note="${targetNote}"]`);
        if(keyEl) keyEl.classList.add('suggested');
    }
}
